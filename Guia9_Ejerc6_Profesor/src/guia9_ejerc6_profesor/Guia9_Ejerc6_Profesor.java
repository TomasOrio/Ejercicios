 ...
 * el encuentro.
 */
package guia9_ejerc6_profesor;

import guia9_ejerc6_profesor.entidades.Curso;

public class Guia9_Ejerc6_Profesor {

    public static void main(String[] args) {
        
        Curso c = new Curso();
        c = c.crearCurso();
        System.out.println("Ganacia semanal: $" + c.calcularGananciaSemanal());
    }
