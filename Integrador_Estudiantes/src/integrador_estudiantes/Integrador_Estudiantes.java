 ...
 */
package integrador_estudiantes;

import integrador_estudiantes.entidades.Estudiante;
import integrador_estudiantes.service.EstudianteService;

public class Integrador_Estudiantes {

    public static void main(String[] args) {
        EstudianteService es = new EstudianteService();
        Estudiante e[] = {new Estudiante("Tomas",8), new Estudiante("Pedro",7), new Estudiante("Juan",9), new Estudiante("Clara",5),
        new Estudiante("Agustina",9), new Estudiante("Alma",6), new Estudiante("Tobias",3), new Estudiante("Miguel",4)};
        es.calcularPromedio(e);
    }
